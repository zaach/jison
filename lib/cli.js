    ...
    var opts = require('@gerhobbelt/nomnom')
        ...
        .options({
            ...
            noDefaultAction: {
                ...
                help: 'OBSOLETED. Use \'--default-action-mode=[for-value,for-location]\' instead (see below in \'--help\' output).'
            },
            defaultActionMode: {
                full: 'default-action',
                flag: false,
                default: ["classic", "merge"],
                ...
                help: 'Specify the kind of default action that jison should include for every parser rule.\n' +
