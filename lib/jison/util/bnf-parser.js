...
switch(arguments[4]) {
case 1:this.$ = $$[$0-4+1-1]; this.$.bnf = $$[$0-4+3-1]; return this.$;
break;
case 2:this.$ = $$[$0-5+1-1]; this.$.bnf = $$[$0-5+3-1]; return this.$;
break;
case 3:this.$ = $$[$0-2+1-1]; yy.addDeclaration(this.$, $$[$0-2+2-1]);
break;
case 4:this.$ = {};
break;
case 5:this.$ = {start: $$[$0-2+2-1]};
break;
case 6:this.$ = {lex: $$[$0-1+1-1]};
break;
case 7:this.$ = {operator: $$[$0-1+1-1]};
break;
case 8:this.$ = [$$[$0-2+1-1]]; this.$.push.apply(this.$, $$[$0-2+2-1]);
break;
case 9:this.$ = 'left';
break;
case 10:this.$ = 'right';
...
break;
case 12:this.$ = $$[$0-2+1-1]; this.$.push($$[$0-2+2-1]);
break;
case 13:this.$ = [$$[$0-1+1-1]];
break;
case 14:this.$ = $$[$0-1+1-1];
break;
case 15:this.$ = $$[$0-2+1-1];
          if($$[$0-2+2-1][0] in this.$) this.$[$$[$0-2+2-1][0]] = this.$[$$[$0-2+2-1][0]].concat($$[$0-2+2-1][1]);
          else  this.$[$$[$0-2+2-1][0]] = $$[$0-2+2-1][1];
break;
case 16:this.$ = {}; this.$[$$[$0-1+1-1][0]] = $$[$0-1+1-1][1];
break;
case 17:this.$ = [$$[$0-4+1-1], $$[$0-4+3-1]];
break;
case 18:this.$ = $$[$0-3+1-1]; this.$.push($$[$0-3+3-1]);
break;
case 19:this.$ = [$$[$0-1+1-1]];
break;
case 20:this.$ = [($$[$0-3+1-1].length ? $$[$0-3+1-1].join(' ') : '')];
            if($$[$0-3+3-1]) this.$.push($$[$0-3+3-1]);
            if($$[$0-3+2-1]) this.$.push($$[$0-3+2-1]);
            if (this.$.length === 1) this.$ = this.$[0];
        
break;
case 21:this.$ = $$[$0-2+1-1]; this.$.push($$[$0-2+2-1])
break;
case 22:this.$ = [];
break;
case 23:this.$ = {prec: $$[$0-2+2-1]};
break;
case 24:this.$ = null;
break;
