...
switch(arguments[4]) {
case 1: this.$ = {rules: $$[$0-5+4-1]};
          if ($$[$0-5+1-1][0]) this.$.macros = $$[$0-5+1-1][0];
          if ($$[$0-5+1-1][1]) this.$.startConditions = $$[$0-5+1-1][1];
          if ($$[$0-5+2-1]) this.$.actionInclude = $$[$0-5+2-1];
          return this.$; 
break;
case 6: 
          this.$ = $$[$0-2+1-1];
          if ('length' in $$[$0-2+2-1]) {
            this.$[0] = this.$[0] || {};
            this.$[0][$$[$0-2+2-1][0]] = $$[$0-2+2-1][1];
          } else {
            this.$[1] = this.$[1] || {};
            for (var name in $$[$0-2+2-1]) {
              this.$[1][name] = $$[$0-2+2-1][name];
            }
          }
...
break;
case 8: this.$ = [$$[$0-2+1-1], $$[$0-2+2-1]]; 
break;
case 9: this.$ = $$[$0-2+2-1]; 
break;
case 10: this.$ = $$[$0-2+2-1]; 
break;
case 11: this.$ = {}; this.$[$$[$0-1+1-1]] = 0; 
break;
case 12: this.$ = $$[$0-2+1-1]; this.$[$$[$0-2+2-1]] = 0; 
break;
case 13: this.$ = {}; this.$[$$[$0-1+1-1]] = 1; 
break;
case 14: this.$ = $$[$0-2+1-1]; this.$[$$[$0-2+2-1]] = 1; 
break;
case 15: this.$ = yytext; 
break;
case 16: this.$ = $$[$0-2+1-1]; this.$.push($$[$0-2+2-1]); 
break;
case 17: this.$ = [$$[$0-1+1-1]]; 
break;
case 18: this.$ = $$[$0-3+1-1] ? [$$[$0-3+1-1], $$[$0-3+2-1], $$[$0-3+3-1]] : [$$[$0-3+2-1],$$[$0-3+3-1]]; 
break;
case 19: this.$ = $$[$0-3+2-1]; 
break;
case 21: this.$ = [$$[$0-1+1-1]]; 
break;
case 22: this.$ = $$[$0-3+1-1]; this.$.push($$[$0-3+3-1]); 
break;
case 23: this.$ = yytext; 
break;
...
break;
case 27: this.$ = $$[$0-2+1-1]+$$[$0-2+2-1]; 
break;
case 29: this.$ = '('+$$[$0-3+2-1]+')'; 
break;
case 30: this.$ = $$[$0-2+1-1]+'+'; 
break;
case 31: this.$ = $$[$0-2+1-1]+'*'; 
break;
case 32: this.$ = $$[$0-2+1-1]+'?'; 
break;
case 33: this.$ = '(?='+$$[$0-2+2-1]+')'; 
break;
case 34: this.$ = '(?!'+$$[$0-2+2-1]+')'; 
break;
case 36: this.$ = $$[$0-2+1-1]+$$[$0-2+2-1]; 
break;
case 38: this.$ = '.'; 
break;
case 39: this.$ = '^'; 
...
case 46: this.$ = yytext; 
break;
case 47: this.$ = yy.prepareString(yytext.substr(1, yytext.length-2)); 
break;
}
},
...
break;
case 2:yy_.yytext = yy_.yytext.substr(2, yy_.yytext.length-3);return 25;
break;
case 3:return 18;
break;
case 4:yy_.yytext = yy_.yytext.replace(/\\"/g,'"');return 50;
break;
case 5:yy_.yytext = yy_.yytext.replace(/\\'/g,"'");return 50;
break;
case 6:return 27;
break;
case 7:return 47;
...
case 24:return 16;
break;
case 25:yy.ruleSection = true; return 6;
break;
case 26:return 49;
break;
case 27:if (yy.freshLine) {this.input('{');return 45;} else this.unput('y');
break;
case 28:return 46;
break;
case 29:yy_.yytext = yy_.yytext.substr(2, yy_.yytext.length-4);return 25;
break;
case 30:/* ignore bad characters */
break;
case 31:return 9;
break;
}
