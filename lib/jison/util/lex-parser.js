...
function anonymous(yytext, yyleng, yylineno, yy) {
    ...
    switch (arguments[4]) {
      case 1:
        this.$ = {rules:$$[$0 - 5 + 4 - 1]};
        if ($$[$0 - 5 + 1 - 1][0]) {
            this.$.macros = $$[$0 - 5 + 1 - 1][0];
        }
        if ($$[$0 - 5 + 1 - 1][1]) {
            this.$.startConditions = $$[$0 - 5 + 1 - 1][1];
        }
        if ($$[$0 - 5 + 2 - 1]) {
      ...
      case 17:
        ...
        break;
      case 18:
        this.$ = $$[$0 - 3 + 1 - 1] ? [$$[$0 - 3 + 1 - 1], $$[$0 - 3 + 2 - 1], $$[$0 - 3 + 3 - 1]] : [$$[$0 - 3 + 2 - 1], $$[$0 - 3 + 3 - 1]];
        break;
      case 19:
        this.$ = $$[$0 - 3 + 2 - 1];
        break;
    ...
    while (true) {
        ...
        if (typeof action === "undefined" || !action.length || !action[0]) {
            if (!recovering) {
                ...
                parseError.call(this, errStr, {text:this.lexer.match, token:this.terminals_[symbol] || symbol, line:this.lexer.yylineno, expected:expected});
            }
            if (recovering == 3) {
                if (symbol == EOF) {
