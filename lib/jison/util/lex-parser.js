...
case 34: this.$ = yytext; 
break;
case 35: this.$ = yy.prepareString(yytext.substr(1, yytext.length-2)); 
break;
}
},
...
break;
case 2:yy_.yytext = yy_.yytext.substr(2, yy_.yytext.length-3);return 14;
break;
case 3:return 12;
break;
case 4:yy_.yytext = yy_.yytext.replace(/\\"/g,'"');return 38;
break;
case 5:yy_.yytext = yy_.yytext.replace(/\\'/g,"'");return 38;
break;
case 6:return 16;
break;
case 7:return 35;
...
case 18:return 28;
break;
case 19:yy.ruleSection = true; return 5;
break;
case 20:return 37;
break;
case 21:if (yy.freshLine) {this.input('{');return 33;} else this.unput('y');
break;
case 22:return 34;
break;
case 23:yy_.yytext = yy_.yytext.substr(2, yy_.yytext.length-4);return 14;
break;
case 24:/* ignore bad characters */
break;
case 25:return 7;
break;
}
