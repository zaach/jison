...
function prepareRules(rules, macros_dict, actions, tokens, startConditions, caseless, caseHelper) {
    ...
    if (macros_dict) {
        macros = prepareMacros(macros_dict);
    }
