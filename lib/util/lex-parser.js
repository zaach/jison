...
var $V0=[6,12,14,16,18,21,58],
    $V1=[18,33,34,38,40,46,47,48,49,54,56,57,68,94,123],
    $V2=[6,12,14,16,18,21,41,58,68,123],
    $V3=[6,12,14,16,18,21,33,34,38,40,41,46,47,48,49,54,56,57,58,68,94,123],
    $V4=[6,12,14,16,18,21,33,34,38,40,41,42,43,46,47,48,49,54,55,56,57,58,63,68,94,123],
    $V5=[6,12,14,16,18,21,22,58],
    $V6=[6,8,12,14,16,18,21,33,34,38,40,46,47,48,49,54,56,57,58,60,68,71,94,123],
    $V7=[8,68],
    $V8=[6,8,18,33,34,38,40,46,47,48,49,54,56,57,60,68,94,123],
    $V9=[48,51],
    $Va=[28,123];
...
table: [
  ...
  __expand__([6,12,14,16,18,21,58,68], [
      2,
      39
    ], {13:16,30:17,31:18,32:19,35:24,37:25,39:29,45:30,33:[
      1,
      21
    ],34:[
      1,
  ...
  __expand__([6,12,14,16,18,21,58,68,123], [
      2,
      35
    ], {124:[
      1,
  ...
  __expand__($V2, [
      2,
      38
    ], {35:24,37:25,39:29,45:30,32:53,33:[
      1,
      21
    ],34:[
      1,
  ...
  __expand__([6,12,14,16,18,21,33,34,38,40,41,42,43,46,47,48,49,51,53,54,55,56,57,58,63,68,94,123], [
      2,
      57
    ], {124:[
      2,
  ...
  __expand__([18,68,123], [
      2,
      39
    ], {30:17,31:18,32:19,35:24,37:25,39:29,45:30,13:79,33:[
      1,
      21
    ],34:[
      1,
  ...
  __expand__($V2, [
      2,
      37
    ], {32:19,35:24,37:25,39:29,45:30,31:83,33:[
      1,
      21
    ],34:[
      1,
...
/*! Conditions:: options */ 
/*! Rule::       "(\\\\|\\"|[^"])*" */ 
 yy_.yytext = yy_.yytext.substr(1, yy_.yytext.length - 2); return 66; 
break;
case 21 : 
/*! Conditions:: options */ 
/*! Rule::       '(\\\\|\\'|[^'])*' */ 
...
/*! Conditions:: set */ 
/*! Rule::       \] */ 
 this.popState('set'); return 51; 
break;
case 80 : 
/*! Conditions:: code */ 
/*! Rule::       [^\r\n]+ */ 
 return 71;      // the bit of CODE just before EOF... 
break;
case 81 : 
/*! Conditions:: path */ 
/*! Rule::       [\r\n] */ 
...
/*! Conditions:: path */ 
/*! Rule::       '[^\r\n]+' */ 
 yy_.yytext = yy_.yytext.substr(1, yy_.yyleng - 2); this.popState(); return 69; 
break;
case 83 : 
/*! Conditions:: path */ 
/*! Rule::       "[^\r\n]+" */ 
