...
function selectTokenStack (fn, enabled) {
    ...
    try {
        ...
        console.log(labeled);
        var reduced_code = enabled ?
            labeled[0].body.body[1] :
            labeled[0].body.body[0] ;

        labeled[0].body = reduced_code;
...
lrGeneratorMixin.generateModule_ = function generateModule_ () {
    ...
    parseFn = selectTokenStack(parseFn, this.options.tokenStack);
