...
parser.parse = lrGeneratorMixin.parse = function parse (input) {
    var self = this,
        stack = [0],
 ...
 * Define base type
 * */
var lrLookaheadParser = generator.beget(lookaheadMixin, lrGeneratorMixin, {
...
exports.main = function main (args) {
    ...
    if (args[2]) {
        ...
        } else if (lfile.extension() === '.jilex') {
            grammar.lex = require("jison/jilex").parse(lfile.read({charset: "utf-8"}));
        }
    }
