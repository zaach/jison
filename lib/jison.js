...
generator.buildProductions = function buildProductions(bnf, productions, nonterminals, symbols, operators, predefined_symbols, descriptions) {
    ...
    if (predefined_symbols) {
        for (symbol in predefined_symbols) {
            let symId = predefined_symbols[symbol];
            if (symId === true) {
...
generator.buildProductionActions = function buildProductionActions(bnf, productions, nonterminals, symbols, operators, predefined_symbols, descriptions) {
    var self = this;
    var actions = [
      '/* this == yyval */',
    ...
    function buildProductionAction(handle) {
        ...
        if (devDebug) Jison.print('\nbuildProductionAction: ', symbol, ':', JSON.stringify(handle, null, 2));
