...
_handle_error_end_of_section:                  // this concludes the error recovery / no error recovery code section choice above
            ...
            case 2:
                ...
                // perform semantic action
                yyval.$ = len ? vstack[sp - len] : undefined; // default to $$ = $1; result is `undefined` when len == 0, hence there's no $1 (you're reducing an epsilon rule!)
