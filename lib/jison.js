        ...
        switch (action[0]) {
            ...
            case 2:
                ...
                if (typeof Jison !== 'undefined' && Jison.parserDebugger) {
                    ...
                    var currentNonterminal;
                    for (var currentKey in this.symbols_) {
                        if (!this.symbols_.hasOwnProperty(currentKey)) {
                            continue;
                        }
                        if (this.symbols_[currentKey] === currentNonterminalCode) {
                            currentNonterminal = currentKey;
                            break;
                        }
                    }
                    Jison.parserDebugger.push({
