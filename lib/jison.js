...
generator.buildProductions = function buildProductions(bnf, productions, nonterminals, symbols, operators, predefined_symbols, descriptions) {
    ...
    //console.log('assert: ', terms[0], this.EOF, terms);
...
function generateGenericHeaderComment() {
    var out = '/* parser generated by jison ' + version + ' */\n'
        ...
        + ' *    terminal_descriptions_: {associative list: number ==> description},\n'
        + ' *    productions_: [...],\n'
        + ' *\n'
...
lrGeneratorMixin.generateModule_ = function generateModule_() {
    ...
    moduleCode += [
        ...
        'terminal_descriptions_: ' + JSON.stringify(produceTerminalDescriptions(this.descriptions_, this.symbols_), null, 2).replace(/"([0-9]+)":/g, '$1:'),
