...
lrGeneratorMixin.generateModule_ = function generateModule_() {
    ...
    this.options.exportSourceCode = exportSourceCode;
    ...
    //   export *all* tables: ............. ${!!(this.options.exportAllTables && this.options.exportAllTables.enabled)}
