...
parser.parse = function parse(input) {
    var self = this,
        stack = [0],        // token stack: stores token which leads to state at the same index (column storage)
        sstack = [0],       // state stack: stores states
...
_handle_error_end_of_section:                  // this concludes the error recovery / no error recovery code section choice above
            ...
            case 2:
                ...
                newState = table[sstack[sstack.length - 1]][stack[stack.length - 1]];
