...
lrGeneratorMixin.generateModule_ = function generateModule_() {
    ...
    function expandConstantsInGeneratedCode(src) {
...
`;
    ...
    return {
        ...
        moduleCode: expandConstantsInGeneratedCode(moduleCode),
        modulePostlude: [
            'parser.originalParseError = parser.parseError;',
            'parser.originalQuoteName = parser.quoteName;',
            ].join('\n'),
        moduleInclude: expandConstantsInGeneratedCode(this.moduleInclude)
    };
};
