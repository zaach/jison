...
parser.parse = function parse (input) {
    ...
    if (typeof this.yy.parseError === 'function') {
        ...
        this.parseError = parser.parseError; // because in the generated code 'this.__proto__.parseError' doesn't work for everyone: http://javascriptweblog.wordpress.com/2010/06/07/understanding-javascript-prototypes/
    }
