 ...
 *
 * This example employs the `pre_parse` hook(s) available with each JISON parser;
 * see faking-multiple-start-rules-alt.jison for another (classic) way to accomplish the same. 
 */
