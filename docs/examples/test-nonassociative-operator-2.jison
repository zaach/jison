...
// (and happen to specify a *left-associative treatment* instead!)
//
// This example serves as a lesson about writing (LA)LR grammars without regard for the intricacies of the
// (LA)LR system.
//
//
// This example is identical to test-nonassociative-operator-1 except now we encode the '=' rule as
