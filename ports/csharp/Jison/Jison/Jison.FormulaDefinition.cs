...
case 12:
				...
				thisS = new ParserValue(ss[so-3].Text != ss[so].Text);
...
case 23:
				...
				thisS = jQuerySheet.FormulaFunctions.Call(ss[so-2].Text);
...
case 24:
				...
				thisS = jQuerySheet.FormulaFunctions.Call(ss[so-3].Text, ss[so-1]);
...
case 42:
				...
				thisS = new ParserValue(ss[so-2].Text + ss[so-1].Text + ss[so].Text);
...
case 43:
				...
				thisS = new ParserValue(ss[so-3].Text + ss[so-2].Text + ss[so-1].Text + ss[so].Text);
