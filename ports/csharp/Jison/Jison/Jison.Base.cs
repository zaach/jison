...
namespace Jison
{
	public class Base
	{
		...
		public void Setup(ref ParserSymbols symbols, ref Dictionary<int, ParserSymbol> terminals, ref Dictionary<int, ParserProduction> productions, ref Dictionary<int, ParserState> table, ref Dictionary<int, ParserAction> defaultActions, ref Dictionary<int, Regex> rules, ref Dictionary<string, LexerConditions> conditions)
		{
			Symbols = symbols;
			Terminals = terminals;
		...
		public virtual ParserValue ParserPerformAction(ref ParserValue thisS, ref ParserValue yy, ref int yystate, ref JList<ParserValue> ss)
		{
			return null;
		}
		...
		public virtual dynamic LexerPerformAction(int avoidingNameCollisions, string Yy_Start)
		{
			return -1;
		}
	}
