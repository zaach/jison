...
/**/namespace Jison/**/
{
	public /**/class Definition/**/ : Base
	{
		...
		/**/public Definition/**/()
        {
			...
			base.Setup(ref Symbols, ref Terminals, ref Productions, ref Table, ref DefaultActions, ref Rules, ref Conditions);
        }
...
break;
case 19:
				//thisS = new ParserValue(Math.Pow(ss[so - 2].DecimalValue, ss[so].DecimalValue));
break;
case 20:
				ss[so - 2].DecimalValue *= -1;
				thisS = ss[so - 2];
break;
case 21:
				ss[so - 2].DecimalValue *= 1;
