...
performAction: function parser__PerformAction(yytext, yystate /* action[1] */, yysp, yyrulelength, yyvstack) {
    ...
    try {
        ...
        for (;;) {
            ...
            case 2:
                ...
                r = this.performAction.call(yyval, yytext, newState, sp - 1, len, vstack);
