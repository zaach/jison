...
performAction: function parser__PerformAction(yytext, yyloc, yystate /* action[1] */, yysp, yyrulelength, yyvstack, yylstack) {
        ...
        for (;;) {
            ...
            if (this.defaultActions[state]) {
                ...
                if (!action) {
                    ...
                    r = this.performAction.call(yyval, yytext, yyloc, NO_ACTION[1], sp - 1, len, vstack, lstack);
            ...
            case 2:
                ...
                r = this.performAction.call(yyval, yytext, yyloc, newState, sp - 1, len, vstack, lstack);
