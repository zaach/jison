(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('@gerhobbelt/xregexp'), require('path'), require('@gerhobbelt/recast')) :
	typeof define === 'function' && define.amd ? define(['fs', '@gerhobbelt/xregexp', 'path', '@gerhobbelt/recast'], factory) :
	(global['lex-parser'] = factory(global.fs,global.XRegExp,global.path,global.recast));
}(this, (function (fs,XRegExp,path,recast) { 'use strict';
