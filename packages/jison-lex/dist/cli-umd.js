...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('fs'), require('path'), require('@gerhobbelt/nomnom'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('@gerhobbelt/recast'), require('assert'), require('@gerhobbelt/ast-util'), require('@gerhobbelt/prettier-miscellaneous')) :
	typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/nomnom', '@gerhobbelt/xregexp', '@gerhobbelt/json5', '@gerhobbelt/recast', 'assert', '@gerhobbelt/ast-util', '@gerhobbelt/prettier-miscellaneous'], factory) :
	(factory(global.fs,global.path,global.nomnom,global.XRegExp,global.json5,global.recast,global.assert,global.astUtils,global.prettierMiscellaneous));
}(this, (function (fs,path,nomnom,XRegExp,json5,recast,assert,astUtils,prettierMiscellaneous) { 'use strict';
