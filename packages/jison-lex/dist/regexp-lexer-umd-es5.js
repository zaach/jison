(function(global,factory){typeof exports==='object'&&typeof module!=='undefined'?module.exports=factory(require('fs'),require('path'),require('@gerhobbelt/recast'),require('@babel/core'),require('@babel/parser'),require('assert'),require('@gerhobbelt/xregexp'),require('@gerhobbelt/json5')):typeof define==='function'&&define.amd?define(['fs','path','@gerhobbelt/recast','@babel/core','@babel/parser','assert','@gerhobbelt/xregexp','@gerhobbelt/json5'],factory):global['regexp-lexer']=factory(global.fs,global.path,global.recast,global.babel,global.parser,global.assert$1,global.XRegExp,global.JSON5);})(this,function(fs,path,recast,babel,parser,assert$1,XRegExp,JSON5){'use strict';fs=fs&&fs.hasOwnProperty('default')?fs['default']:fs;path=path&&path.hasOwnProperty('default')?path['default']:path;recast=recast&&recast.hasOwnProperty('default')?recast['default']:recast;parser=parser&&parser.hasOwnProperty('default')?parser['default']:parser;assert$1=assert$1&&assert$1.hasOwnProperty('default')?assert$1['default']:assert$1;XRegExp=XRegExp&&XRegExp.hasOwnProperty('default')?XRegExp['default']:XRegExp;JSON5=JSON5&&JSON5.hasOwnProperty('default')?JSON5['default']:JSON5;// Return TRUE if `src` starts with `searchString`. 
