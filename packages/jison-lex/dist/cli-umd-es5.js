...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(require('fs'), require('path'), require('@gerhobbelt/nomnom'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('@gerhobbelt/recast'), require('assert'), require('@gerhobbelt/ast-util'), require('@gerhobbelt/prettier-miscellaneous')) : typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/nomnom', '@gerhobbelt/xregexp', '@gerhobbelt/json5', '@gerhobbelt/recast', 'assert', '@gerhobbelt/ast-util', '@gerhobbelt/prettier-miscellaneous'], factory) : factory(global.fs, global.path, global.nomnom, global.XRegExp, global.json5, global.recast, global.assert, global.astUtils, global.prettierMiscellaneous);
})(undefined, function (fs, path, nomnom, XRegExp, json5, recast, assert, astUtils, prettierMiscellaneous) {
    'use strict';
    ...
    */
    ...
    function generateErrorClass() {
        ...
        var prelude = ['// See also:', '// http://stackoverflow.com/questions/1382107/whats-a-good-way-to-extend-error-in-javascript/#35881508', '// but we keep the prototype.constructor and prototype.name assignment lines too for compatibility', '// with userland code which might access the derived class in a \'classic\' way.', printFunctionSourceCode(JisonLexerError), printFunctionSourceCodeContainer(__extra_code__), ''];
    ...
    */
    ...
    function generateModuleBody(opt) {
        ...
        if (opt.rules.length > 0 || opt.__in_rules_failure_analysis_mode__) {
            ...
            var code = [rmCommonWS(_templateObject29), '/*JISON-LEX-ANALYTICS-REPORT*/' /* slot #1: placeholder for analysis report further below */
            ];
            ...
            code.push(rmCommonWS(_templateObject30, performActionCode, simpleCaseActionClustersCode, rulesCode, conditionsCode));
    ...
    function generateGenericHeaderComment() {
        var out = rmCommonWS(_templateObject31, version$1);
    ...
    function generateESModule(opt) {
        ...
        var out = [generateGenericHeaderComment(), '', 'var lexer = (function () {', jisonLexerErrorDefinition, '', generateModuleBody(opt), '', opt.moduleInclude ? opt.moduleInclude + ';' : '', '', 'return lexer;', '})();', '', 'function yylex() {', '    return lexer.lex.apply(lexer, arguments);', '}', rmCommonWS(_templateObject32)];
