(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('fs'), require('@gerhobbelt/recast'), require('assert'), require('@gerhobbelt/ast-util'), require('@gerhobbelt/prettier-miscellaneous')) :
	typeof define === 'function' && define.amd ? define(['@gerhobbelt/xregexp', '@gerhobbelt/json5', 'fs', '@gerhobbelt/recast', 'assert', '@gerhobbelt/ast-util', '@gerhobbelt/prettier-miscellaneous'], factory) :
	(global['regexp-lexer'] = factory(global.XRegExp,global.json5,global.fs,global.recast,global.assert,global.astUtils,global.prettierMiscellaneous));
}(this, (function (XRegExp,json5,fs,recast,assert,astUtils,prettierMiscellaneous) { 'use strict';
