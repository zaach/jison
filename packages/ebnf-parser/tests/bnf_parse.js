...
describe("BNF parser", function () {
  ...
  it("test token with type", function () {
    ...
    var expected = {bnf: {test: ["foo bar", "baz"], hello: ["world"]}, unknownDecls: [{name: 'type', value: '<type> blah'}]};
  ...
  it("test windows line endings", function () {
    var grammar = "%{baz\r\n%}%% test: foo bar | {\r\naction;\r\nhi};\r\nhello: world ;%%foo;\r\nbar;";
    var expected = {bnf: {test: ["foo bar", [ "", "action;\r\nhi" ]], hello: ["world"]}, moduleInclude: 'baz\n\nfoo;\r\nbar'};
  ...
  it("test if %options names with a hyphen are correctly recognized", function () {
    ...
    var expected = {
        ...
        options: {
            "bugABoo": true   // bug-a-boo gets automatically camelCased!
        }
    };
  ...
  it("test unknown decls", function () {
    var grammar = "%foo bar\n%foo baz\n%qux { fizzle }\n%%hello: world;%%";
    var expected = {bnf: {hello: ["world"]}, unknownDecls: [{name: 'foo', value: 'bar'}, {name: 'foo', value: 'baz'}, {name: 'qux', value: '{ fizzle }'}]};
