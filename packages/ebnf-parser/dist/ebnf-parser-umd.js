(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('path'), require('@gerhobbelt/recast'), require('babel-core'), require('assert'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5')) :
    typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/recast', 'babel-core', 'assert', '@gerhobbelt/xregexp', '@gerhobbelt/json5'], factory) :
    (global['ebnf-parser'] = factory(global.fs,global.path,global.recast,global.babel,global.assert$1,global.XRegExp,global.JSON5));
}(this, (function (fs,path,recast,babel,assert$1,XRegExp,JSON5) { 'use strict';
