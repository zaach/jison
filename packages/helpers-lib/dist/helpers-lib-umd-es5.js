(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('path'), require('@gerhobbelt/recast'), require('@babel/core'), require('@gerhobbelt/babel-parser'), require('assert')) : typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/recast', '@babel/core', '@gerhobbelt/babel-parser', 'assert'], factory) : global['jison-helpers-lib'] = factory(global.fs, global.path, global.recast, global.babel, global.babelParser, global.assert);
})(this, function (fs, path, recast, babel, babelParser, assert) {
  'use strict';
